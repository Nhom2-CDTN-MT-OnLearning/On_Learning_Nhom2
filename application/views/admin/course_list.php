<div class="row">
    <div class="col-sm-4 class1">
        <ul class="nav nav-pills flex-column">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("index.php/admin/index/") ?>"><img src="<?php echo base_url("images/main.png"); ?>">&nbsp;&nbsp; Trang chủ</a>
            </li>
            <li class="nav-item">
    ...
    <div class="col-sm-6 class1">
        <h4>Danh sách các khóa học chương trình lớp 12</h4>
